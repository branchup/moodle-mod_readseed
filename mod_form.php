...
/**
 * The main readseed configuration form
 *
 ...
 */
class mod_readseed_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('readseedname', constants::M_COMPONENT), array('size'=>'64'));
        ...
        $mform->addHelpButton('name', 'readseedname', constants::M_COMPONENT);
		...
		//time target
        $timelimit_options = \mod_readseed\utils::get_timelimit_options();
		...
		//The passage
		//$edfileoptions = readseed_editor_with_files_options($this->context);
		$ednofileoptions = readseed_editor_no_files_options($this->context);
        ...
        //region
        $regionoptions = \mod_readseed\utils::get_region_options();
        ...
        //expiredays
        $expiredaysoptions = \mod_readseed\utils::get_expiredays_options();
        ...
        $autoacc_options = \mod_readseed\utils::get_accadjust_options();
        ...
        if ($mods = get_course_mods($COURSE->id)) {
            ...
            foreach ($mods as $mod) {
                ...
                if ($module = get_coursemodule_from_instance($mod->modname, $mod->instance, $COURSE->id)) {
                    // Exclude this Read Seed activity (if it's already been saved.)
	 ...
	 * See lib.php readseed_get_completion_state()
     */
