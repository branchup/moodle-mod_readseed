...
$string['modulename'] = 'Read Seed';
$string['modulenameplural'] = 'Read Seeds';
$string['modulename_help'] = 'Read Seed is an activity designed to assist teachers in evaluating their students reading fluency. Students read a passage, set by the teacher, into a microphone. Later the teacher can mark words as incorrect and get the student WCPM(Words Correct Per Minute) scores.';
$string['readseedfieldset'] = 'Custom example fieldset';
$string['readseedname'] = 'Read Seed';
$string['readseedname_help'] = 'This is the content of the help tooltip associated with the readseedname field. Markdown syntax is supported.';
$string['readseed'] = 'readseed';
...
$string['pluginadministration'] = 'Read Seed Administration';
$string['pluginname'] = 'Read Seed Activity';
...
$string['readseedsettings'] = 'readseed settings';
$string['readseed:addinstance'] = 'Add a new Read Seed';
$string['readseed:view'] = 'View Read Seed';
$string['readseed:view'] = 'Preview Read Seed';
$string['readseed:itemview'] = 'View items';
$string['readseed:itemedit'] = 'Edit items';
$string['readseed:tts'] = 'Can use Text To Speech(tts)';
$string['readseed:manageattempts'] = 'Can manage Read Seed attempts';
$string['readseed:manage'] = 'Can manage Read Seed instances';
$string['readseed:preview'] = 'Can preview Read Seed activities';
...
$string['readseedtask'] ='Read Seed Task';
$string['passagelabel'] ='Reading Passage';
$string['welcomelabel'] ='Default Welcome';
$string['welcomelabel_details'] ='The default text to show in the welcome field when creating a new Read Seed activity.';
$string['feedbacklabel'] ='Default Feedback';
$string['feedbacklabel_details'] ='The default text to show in the feedback field when creating a new Read Seed activity.';
...
$string['enableai_details']='Read Seed can evaluate results from a student attempt using AI. Check to enable.';
...
$string['noapiuser'] = "No API user entered. Read Seed will not work correctly.";
$string['noapisecret'] = "No API secret entered. Read Seed will not work correctly.";
$string['credentialsinvalid'] = "The API user and secret entered could not be used to get access. Please check them.";
$string['appauthorised']= "Poodll Read Seed is authorised for this site.";
$string['appnotauthorised']= "Poodll Read Seed is NOT authorised for this site.";
$string['refreshtoken']= "Refresh license information";
$string['notokenincache']= "Refresh to see license information. Contact Poodll support if there is a problem.";

$string['privacy:metadata:attemptid']='The unique identifier of a users Read Seed attempt.';
$string['privacy:metadata:readseedid']='The unique identifier of a Read Seed activity instance.';
$string['privacy:metadata:userid']='The user id for the Read Seed attempt';
...
$string['privacy:metadata:attempttable']='Stores the scores and other user data associated with a Read Seed attempt.';
$string['privacy:metadata:aitable']='Stores the scores and other user data associated with a Read Seed attempt as evaluated by machine.';
...
$string['privacy:metadata:cloudpoodllcom:userid']='The Read Seed plugin includes the moodle userid in the urls of recordings and transcripts';
$string['privacy:metadata:cloudpoodllcom']='The Read Seed plugin stores recordings in AWS S3 buckets via cloud.poodll.com.';
...
$string['addtextpromptlongitem'] = 'Add text multichoice(long) item';
$string['addtextpromptshortitem'] = 'Add text multichoice(short) item';
$string['addpicturepromptitem'] = 'Add Picture Prompt Item';
$string['addaudioresponseitem'] = 'Add audio response item';
