 ...
 * @return string
 */
 public function add_edit_page_links($readseed) {
		global $CFG;
        $itemid = 0;

        $output = $this->output->heading(get_string("whatdonow", "readseed"), 3);
        $links = array();

		$addtextchoiceitemurl = new \moodle_url('/mod/readseed/rsquestion/managersquestions.php',
     ...
     $addtextboxchoiceitemurl = new \moodle_url('/mod/readseed/rsquestion/managersquestions.php',
     ...
     $addaudioresponseitemurl = new \moodle_url('/mod/readseed/rsquestion/managersquestions.php',
	 ...
	 */
	function show_items_list($items,$readseed,$cm){
		...
		foreach ($items as $item) {
            ...
            $actionurl = '/mod/readseed/rsquestion/managersquestions.php';
