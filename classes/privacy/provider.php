...
/**
 * Privacy Subsystem implementation for mod_readseed.
 *
...
namespace mod_readseed\privacy;
...
/**
 * Privacy Subsystem for mod_readseed
 *
 * @copyright  2018 Justin Hunt https://poodll.com
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    public static function _get_metadata(collection $collection) {
        ...
        $userdetail = [
            ...
            'readseedid' => 'privacy:metadata:readseedid',
    ...
    public static function _get_contexts_for_userid($userid) {
        ...
        $sql = "SELECT c.id
            ...
            INNER JOIN {" . constants::M_USERTABLE . "} usert ON usert.readseedid = actt.id
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        $sql = "SELECT usert.userid
                  ...
                  JOIN {" . constants::M_USERTABLE . "} usert ON usert.readseedid = actt.id
    ...
    public static function _export_user_data(approved_contextlist $contextlist) {
        ...
        $sql = "SELECT usert.id as attemptid,
                  ...
                  JOIN {" . constants::M_TABLE . "} actt ON usert.readseedid = actt.id
    ...
    /**
     * Export the supplied personal data for a single readseed attempt along with any generic data or area files.
     *
     * @param array $attemptdata the personal data to export
     * @param \context_module $context the context of the readseed.
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        $attempts = $DB->get_records(constants::M_USERTABLE, ['readseedid' => $instanceid], '', 'id');

        // Delete AI data
        $DB->delete_records_list(constants::M_AITABLE, 'attemptid', array_keys($attempts));

        // Now delete all attempts
        $DB->delete_records(constants::M_USERTABLE, ['readseedid' => $instanceid]);
    }
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        ...
        foreach ($contextlist->get_contexts() as $context) {
            if ($context->contextlevel == CONTEXT_MODULE) {
                ...
                $entries = $DB->get_records(constants::M_USERTABLE, ['readseedid' => $instanceid, 'userid' => $userid],
                    '', 'id');
                ...
                $DB->delete_records(constants::M_USERTABLE, ['readseedid' => $instanceid, 'userid' => $userid]);
            }
        }
    }
    ...
    public static function delete_data_for_users(approved_userlist $userlist) {
        ...
        $attemptswhere = "readseedid = :instanceid AND userid {$userinsql}";
        ...
        $deletewhere = "readseedid = :instanceid AND userid {$userinsql}";
