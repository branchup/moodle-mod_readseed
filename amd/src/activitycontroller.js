/* jshint ignore:start */
define(['jquery','jqueryui', 'core/log','mod_readseed/definitions','mod_readseed/recorderhelper','mod_readseed/quizhelper'], function($, jqui, log, def, recorderhelper, quizhelper) {
