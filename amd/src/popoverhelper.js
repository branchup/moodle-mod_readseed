define(['jquery','core/log','mod_readseed/definitions','mod_readseed/dependencyloader','theme_boost/popover'], function($,log,def) {
    "use strict"; // jshint ;_;
 ...
 */
    ...
    log.debug('Read Seed Popover helper: initialising');
