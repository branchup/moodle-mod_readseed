...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(130);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(41), __webpack_require__(306)(module)))
...
var createResizeDetector = _interopDefault(__webpack_require__(307));
var React = __webpack_require__(0);
var React__default = _interopDefault(React);
var PropTypes = _interopDefault(__webpack_require__(1));
var ReactDOM = _interopDefault(__webpack_require__(92));
var invariant = _interopDefault(__webpack_require__(7));
var throttle = _interopDefault(__webpack_require__(318));
var debounce = _interopDefault(__webpack_require__(319));
var isShallowEqual = _interopDefault(__webpack_require__(320));
...
$export($export.S + $export.F * !__webpack_require__(12), 'Object', { defineProperties: __webpack_require__(99) });
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(19)(proto, TO_PRIMITIVE, __webpack_require__(218));
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(126),ba=__webpack_require__(301);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var elementUtilsMaker       = __webpack_require__(308);
var listenerHandlerMaker    = __webpack_require__(309);
var idGeneratorMaker        = __webpack_require__(310);
var idHandlerMaker          = __webpack_require__(311);
var reporterMaker           = __webpack_require__(312);
var browserDetector         = __webpack_require__(129);
var batchProcessorMaker     = __webpack_require__(313);
var stateHandler            = __webpack_require__(315);

//Detection strategies.
var objectStrategyMaker     = __webpack_require__(316);
var scrollStrategyMaker     = __webpack_require__(317);
...
var node_modules_warning_warning = __webpack_require__(14);
...
// CONCATENATED MODULE: ./lib/moodle.js
function getImageUrl(imageName) {
  var component = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'core';
...
function moodle_sendSubmission(wwwRoot, cmid, fileName, recTime) {
  var promise = new Promise(function (resolve, reject) {
    var xhr = new XMLHttpRequest(); //set up our handler for the response
...
// CONCATENATED MODULE: ./lib/cloudpoodll.js
var API;
function getModule() {
  return API;
}
...
// CONCATENATED MODULE: ./components/Recorder.js
function Recorder_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Recorder_typeof = function _typeof(obj) { return typeof obj; }; } else { Recorder_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Recorder_typeof(obj); }
...
function Recorder_possibleConstructorReturn(self, call) { if (call && (Recorder_typeof(call) === "object" || typeof call === "function")) { return call; } return Recorder_assertThisInitialized(self); }

function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }

function Recorder_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }

function _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }

function Recorder_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function Recorder_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var Recorder_Recorder =
/*#__PURE__*/
function (_React$PureComponent) {
  Recorder_inherits(Recorder, _React$PureComponent);
  ...
  function Recorder(props) {
    ...
    _this = Recorder_possibleConstructorReturn(this, _getPrototypeOf(Recorder).call(this, props));

    Recorder_defineProperty(Recorder_assertThisInitialized(Recorder_assertThisInitialized(_this)), "state", {
      loaded: false
    });

    Recorder_defineProperty(Recorder_assertThisInitialized(Recorder_assertThisInitialized(_this)), "handleEvents", function (message) {
      _this.props.onMessageReceived && _this.props.onMessageReceived(message);
    });

    _this.divRef = react_default.a.createRef();
    _this.domId = 'therecorderid';
    return _this;
  }
  ...
  _createClass(Recorder, [{
    ...
    value: function componentDidMount() {
      ...
      var CloudPoodll = getModule();
      CloudPoodll.createRecorder(this.domId);
      CloudPoodll.theCallback = this.handleEvents;
      CloudPoodll.initEvents();
      this.CloudPoodll = CloudPoodll; // Find the iframe.

      this.iframe = this.divRef.current.querySelector('iframe'); // Observe the onload event.

      var origOnLoad = this.iframe.onload;

      this.iframe.onload = function () {
        origOnLoad && origOnLoad.bind(_this2.iframe).apply(void 0, arguments);
    ...
    key: "render",
    value: function render() {
      var wrapperStyles = this.state.loaded ? {
        backgroundImage: 'none'
      } : {};
      return react_default.a.createElement("div", {
        className: "mod_readseed_recording_cont",
        style: wrapperStyles
      }, react_default.a.createElement("div", {
        id: "mod_readseed_recorder_cont",
        className: "mod_readseed_recorder_cont mod_readseed_center"
      }, react_default.a.createElement("div", {
        ref: this.divRef,
        ...
        "data-height": this.props.height // data-iframeclass={this.props.iframeclass}
        ,
...
Recorder_defineProperty(Recorder_Recorder, "propTypes", {
  onMessageReceived: prop_types_default.a.func
});

var ConnectedRecorder = connect_connect(function (state) {
  return {
...
function AnimatedSprites_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function AnimatedSprites_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function AnimatedSprites_createClass(Constructor, protoProps, staticProps) { if (protoProps) AnimatedSprites_defineProperties(Constructor.prototype, protoProps); if (staticProps) AnimatedSprites_defineProperties(Constructor, staticProps); return Constructor; }

function AnimatedSprites_possibleConstructorReturn(self, call) { if (call && (AnimatedSprites_typeof(call) === "object" || typeof call === "function")) { return call; } return AnimatedSprites_assertThisInitialized(self); }

function AnimatedSprites_getPrototypeOf(o) { AnimatedSprites_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return AnimatedSprites_getPrototypeOf(o); }

function AnimatedSprites_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) AnimatedSprites_setPrototypeOf(subClass, superClass); }

function AnimatedSprites_setPrototypeOf(o, p) { AnimatedSprites_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return AnimatedSprites_setPrototypeOf(o, p); }
...
var AnimatedSprites_AnimatedSprites =
/*#__PURE__*/
function (_PureComponent) {
  AnimatedSprites_inherits(AnimatedSprites, _PureComponent);

  function AnimatedSprites(props) {
    var _this;

    AnimatedSprites_classCallCheck(this, AnimatedSprites);

    _this = AnimatedSprites_possibleConstructorReturn(this, AnimatedSprites_getPrototypeOf(AnimatedSprites).call(this, props));

    AnimatedSprites_defineProperty(AnimatedSprites_assertThisInitialized(AnimatedSprites_assertThisInitialized(_this)), "animate", function () {
      var _this$state$pos = _slicedToArray(_this.state.pos, 2),
          x = _this$state$pos[0],
          y = _this$state$pos[1];

      if (x + 1 < _this.props.spritesPerRow) {
        x++;
      } else {
        x = 0;
        y++;
      ...
      var total = y * _this.props.spritesPerRow + x + 1;

      if (total > _this.props.totalSprites) {
        x = 0;
        y = 0;
      }

      if (_this.props.startPosition[0] === x && _this.props.startPosition[1] === y) {
        if (!_this.props.loop) {
          _this.stopAnimation();
  ...
  AnimatedSprites_createClass(AnimatedSprites, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.startAnimation();
    }
...
AnimatedSprites_defineProperty(AnimatedSprites_AnimatedSprites, "propTypes", {
  src: prop_types_default.a.string.isRequired,
  fps: prop_types_default.a.number,
  loop: prop_types_default.a.bool,
  loopPause: prop_types_default.a.number,
  startPosition: prop_types_default.a.arrayOf(prop_types_default.a.number),
  ...
  onFinish: prop_types_default.a.func
});

AnimatedSprites_defineProperty(AnimatedSprites_AnimatedSprites, "defaultProps", {
  fps: 16,
  loop: false,
  loopPause: 0,
  startPosition: [0, 0]
...
/* harmony default export */ var components_AnimatedSprites = (AnimatedSprites_AnimatedSprites);
...
// CONCATENATED MODULE: ./lib/seed.js
var BLOOM = 'bloom';
...
var submissionSubmitted = createAction('submissionSubmitted', function (attemptId) {
  return {
    attemptId: attemptId
  };
});
var actions_sendSubmission = function sendSubmission(mediaUrl, recordTime) {
  return function (dispatch, getState) {
    var _getState$options = getState().options,
        wwwroot = _getState$options.wwwroot,
        cmid = _getState$options.cmid;
    moodle_sendSubmission(wwwroot, cmid, mediaUrl, recordTime).then(function (attemptId) {
...
var setQuestionAnswer = createAction('setQuestionAnswer', function (questionNumber, answerIndex) {
  return {
    questionNumber: questionNumber,
    answerIndex: answerIndex
  };
});
var setCurrentQuestionNumber = createAction('setCurrentQuestionNumber', function (questionNumber) {
  return {
    questionNumber: questionNumber
  };
});
var actions_submitQuizResults = function submitQuizResults() {
  return function (dispatch, getState) {
    var state = getState();
...
var setMrSeedMode = createAction('setMrSeedMode', function (mode) {
  return {
    mode: mode
  };
});
var actions_makeMrSeedShakeHead = function makeMrSeedShakeHead() {
  return setMrSeedMode(SMH);
};
var actions_makeMrSeedGiveThumbsUp = function makeMrSeedGiveThumbsUp() {
  return setMrSeedMode(THUMBS_UP);
};
var actions_makeMrSeedListen = function makeMrSeedListen() {
  return setMrSeedMode(LISTENING);
};
var actions_makeMrSeedReady = function makeMrSeedReady() {
  return setMrSeedMode(READY);
};
...
function MrSeed_extends() { MrSeed_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return MrSeed_extends.apply(this, arguments); }

function MrSeed_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function MrSeed_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function MrSeed_createClass(Constructor, protoProps, staticProps) { if (protoProps) MrSeed_defineProperties(Constructor.prototype, protoProps); if (staticProps) MrSeed_defineProperties(Constructor, staticProps); return Constructor; }

function MrSeed_possibleConstructorReturn(self, call) { if (call && (MrSeed_typeof(call) === "object" || typeof call === "function")) { return call; } return MrSeed_assertThisInitialized(self); }

function MrSeed_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function MrSeed_getPrototypeOf(o) { MrSeed_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return MrSeed_getPrototypeOf(o); }

function MrSeed_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) MrSeed_setPrototypeOf(subClass, superClass); }
...
var smhUrl = getImageUrl('sprites/smh', 'mod_readseed');
var thumbsUpUrl = getImageUrl('sprites/thumbsup', 'mod_readseed');
var yawnUrl = getImageUrl('sprites/yawn', 'mod_readseed');
function getSpritesUrls() {
...
/*#__PURE__*/
function (_React$PureComponent) {
  MrSeed_inherits(MrSeed, _React$PureComponent);

  function MrSeed() {
    MrSeed_classCallCheck(this, MrSeed);

    return MrSeed_possibleConstructorReturn(this, MrSeed_getPrototypeOf(MrSeed).apply(this, arguments));
  }
  ...
  MrSeed_createClass(MrSeed, [{
    ...
    value: function renderSprite() {
      ...
      var spriteWidth = 688;
      var spriteHeight = 645;
      var desiredWidth = this.props.width || spriteWidth;
      var desiredHeight = this.props.height || spriteHeight;
      var widthRatio = desiredWidth / spriteWidth;
      var heightRatio = desiredHeight / spriteHeight;
      var displayWidth;
      var displayHeight;
...
/* harmony default export */ var components_MrSeed = (ConnectedSeed);
// EXTERNAL MODULE: ./node_modules/react-sizeme/dist/react-sizeme.js
var react_sizeme = __webpack_require__(95);
var react_sizeme_default = /*#__PURE__*/__webpack_require__.n(react_sizeme);

// CONCATENATED MODULE: ./components/ScrollView.js
function ScrollView_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { ScrollView_typeof = function _typeof(obj) { return typeof obj; }; } else { ScrollView_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return ScrollView_typeof(obj); }
...
function ScrollView_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ScrollView_createClass(Constructor, protoProps, staticProps) { if (protoProps) ScrollView_defineProperties(Constructor.prototype, protoProps); if (staticProps) ScrollView_defineProperties(Constructor, staticProps); return Constructor; }

function ScrollView_possibleConstructorReturn(self, call) { if (call && (ScrollView_typeof(call) === "object" || typeof call === "function")) { return call; } return ScrollView_assertThisInitialized(self); }

function ScrollView_getPrototypeOf(o) { ScrollView_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return ScrollView_getPrototypeOf(o); }

function ScrollView_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) ScrollView_setPrototypeOf(subClass, superClass); }

function ScrollView_setPrototypeOf(o, p) { ScrollView_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return ScrollView_setPrototypeOf(o, p); }

function ScrollView_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function ScrollView_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var ScrollViewContent = react_sizeme_default()(sizeMeOptions)(function (props) {
  return props.children;
});

var ScrollView_ScrollView =
/*#__PURE__*/
function (_React$PureComponent) {
  ScrollView_inherits(ScrollView, _React$PureComponent);
  ...
  function ScrollView(props) {
    ...
    _this = ScrollView_possibleConstructorReturn(this, ScrollView_getPrototypeOf(ScrollView).call(this, props));

    ScrollView_defineProperty(ScrollView_assertThisInitialized(ScrollView_assertThisInitialized(_this)), "state", {
      isScrollable: false,
      maxScroll: 0,
      scrollingTo: 0
    });

    ScrollView_defineProperty(ScrollView_assertThisInitialized(ScrollView_assertThisInitialized(_this)), "handleContentSizeChange", function () {
      _this.setUp();
    });

    ScrollView_defineProperty(ScrollView_assertThisInitialized(ScrollView_assertThisInitialized(_this)), "handleScrollDown", function () {
      _this.scrollBy(100);
    });

    ScrollView_defineProperty(ScrollView_assertThisInitialized(ScrollView_assertThisInitialized(_this)), "handleScrollUp", function () {
      _this.scrollBy(-100);
    });
  ...
  ScrollView_createClass(ScrollView, [{
    ...
    key: "scrollBy",
    value: function scrollBy(value) {
      var node = this.divRef.current;
      var to = Math.max(0, node.scrollTop + value);
      node.scrollTo({
        top: to,
        behavior: 'smooth'
      });
    ...
    value: function renderBeforeContent() {
      ...
      return react_default.a.createElement("div", {
        className: "mod_readseed-scrollview-before"
      });
    }
  }, {
    ...
    value: function renderScrollButtons() {
      ...
      return react_default.a.createElement("div", {
        className: "mod_readseed-scrollview-actions"
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        className: "mod_readseed-scrollview-wrapper"
      }, react_default.a.createElement("div", {
        className: "mod_readseed-scrollview",
        ref: this.divRef
      }, react_default.a.createElement(ScrollViewContent, {
        onSize: this.handleContentSizeChange
      }, this.props.children), isScrollable ? react_default.a.createElement("div", {
        style: {
          height: '100px',
          minHeight: '100px'
        }
      }) : null), this.renderBeforeContent(), this.renderScrollButtons());
    }
  }]);
...
ScrollView_defineProperty(ScrollView_ScrollView, "propTypes", {
  className: prop_types_default.a.string,
  style: prop_types_default.a.object,
  children: prop_types_default.a.any,
  size: prop_types_default.a.object
});

ScrollView_defineProperty(ScrollView_ScrollView, "defaultProps", {
  className: ''
});

/* harmony default export */ var components_ScrollView = (Object(react_sizeme["withSize"])(sizeMeOptions)(ScrollView_ScrollView));
// CONCATENATED MODULE: ./components/Passage.js
function Passage_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Passage_typeof = function _typeof(obj) { return typeof obj; }; } else { Passage_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Passage_typeof(obj); }

function Passage_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { Passage_defineProperty(target, key, source[key]); }); } return target; }

function Passage_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function Passage_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Passage_createClass(Constructor, protoProps, staticProps) { if (protoProps) Passage_defineProperties(Constructor.prototype, protoProps); if (staticProps) Passage_defineProperties(Constructor, staticProps); return Constructor; }

function Passage_possibleConstructorReturn(self, call) { if (call && (Passage_typeof(call) === "object" || typeof call === "function")) { return call; } return Passage_assertThisInitialized(self); }

function Passage_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function Passage_getPrototypeOf(o) { Passage_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Passage_getPrototypeOf(o); }

function Passage_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) Passage_setPrototypeOf(subClass, superClass); }

function Passage_setPrototypeOf(o, p) { Passage_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Passage_setPrototypeOf(o, p); }

function Passage_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
/*#__PURE__*/
function (_React$PureComponent) {
  Passage_inherits(Passage, _React$PureComponent);

  function Passage() {
    Passage_classCallCheck(this, Passage);

    return Passage_possibleConstructorReturn(this, Passage_getPrototypeOf(Passage).apply(this, arguments));
  }
...
function TextToSpeech_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function TextToSpeech_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function TextToSpeech_createClass(Constructor, protoProps, staticProps) { if (protoProps) TextToSpeech_defineProperties(Constructor.prototype, protoProps); if (staticProps) TextToSpeech_defineProperties(Constructor, staticProps); return Constructor; }

function TextToSpeech_possibleConstructorReturn(self, call) { if (call && (TextToSpeech_typeof(call) === "object" || typeof call === "function")) { return call; } return TextToSpeech_assertThisInitialized(self); }

function TextToSpeech_getPrototypeOf(o) { TextToSpeech_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return TextToSpeech_getPrototypeOf(o); }

function TextToSpeech_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) TextToSpeech_setPrototypeOf(subClass, superClass); }

function TextToSpeech_setPrototypeOf(o, p) { TextToSpeech_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return TextToSpeech_setPrototypeOf(o, p); }

function TextToSpeech_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function TextToSpeech_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }




var TextToSpeech_TextToSpeech =
/*#__PURE__*/
function (_React$PureComponent) {
  TextToSpeech_inherits(TextToSpeech, _React$PureComponent);

  function TextToSpeech(props) {
    var _this;

    TextToSpeech_classCallCheck(this, TextToSpeech);

    _this = TextToSpeech_possibleConstructorReturn(this, TextToSpeech_getPrototypeOf(TextToSpeech).call(this, props));

    TextToSpeech_defineProperty(TextToSpeech_assertThisInitialized(TextToSpeech_assertThisInitialized(_this)), "handleRead", function (e) {
      e.preventDefault();
      var content = _this.divRef.current.textContent;
      var message = new SpeechSynthesisUtterance(content);
  ...
  TextToSpeech_createClass(TextToSpeech, [{
    ...
    value: function render() {
      return react_default.a.createElement("div", {
        ...
        ref: this.divRef
      }, this.props.children), react_default.a.createElement("a", {
        href: "#",
...
/*#__PURE__*/
function (_React$PureComponent) {
  Question_inherits(Question, _React$PureComponent);
  ...
  function Question() {
    ...
    _this = Question_possibleConstructorReturn(this, (_getPrototypeOf2 = Question_getPrototypeOf(Question)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Question_defineProperty(Question_assertThisInitialized(Question_assertThisInitialized(_this)), "handleAnswerSelected", function (e, answer) {
      e.preventDefault();

      _this.props.onAnswerSelected(answer.index);
    });

    Question_defineProperty(Question_assertThisInitialized(Question_assertThisInitialized(_this)), "renderAnswer", function (answer) {
      var answered = _this.props.selectedAnswer;
      var isSelected = answer.index == _this.props.selectedAnswer;
      var classNames = isSelected ? ['is-selected'] : [];

      if (_this.props.correctAnswer) {
        var isCorrect = answered && _this.props.correctAnswer == answer.index;
        var isIncorrect = answered && !isCorrect;
      ...
      return react_default.a.createElement("a", {
        ...
        onClick: function onClick(e) {
          return _this.handleAnswerSelected(e, answer);
        },
        className: "".concat(classNames.join(' '), " mod_readseed-answer")
      }, answer.text);
    });
  ...
  Question_createClass(Question, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        className: "".concat(this.props.selectedAnswer ? 'is-answered' : '', " mod_readseed-question")
      }, react_default.a.createElement("div", {
        className: "mod_readseed-question-title"
      }, react_default.a.createElement(components_TextToSpeech, null, react_default.a.createElement("span", {
        dangerouslySetInnerHTML: {
          __html: q.text
        }
      }))), react_default.a.createElement("div", {
        className: "mod_readseed-answers"
...
Question_defineProperty(Question_Question, "propTypes", {
  question: prop_types_default.a.object.isRequired,
  onAnswerSelected: prop_types_default.a.func.isRequired,
  correctAnswer: prop_types_default.a.number,
  // When provided, will display visual feedback.
  selectedAnswer: prop_types_default.a.number
});
...
function QuizQuestion_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function QuizQuestion_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function QuizQuestion_createClass(Constructor, protoProps, staticProps) { if (protoProps) QuizQuestion_defineProperties(Constructor.prototype, protoProps); if (staticProps) QuizQuestion_defineProperties(Constructor, staticProps); return Constructor; }

function QuizQuestion_possibleConstructorReturn(self, call) { if (call && (QuizQuestion_typeof(call) === "object" || typeof call === "function")) { return call; } return QuizQuestion_assertThisInitialized(self); }

function QuizQuestion_getPrototypeOf(o) { QuizQuestion_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return QuizQuestion_getPrototypeOf(o); }

function QuizQuestion_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) QuizQuestion_setPrototypeOf(subClass, superClass); }

function QuizQuestion_setPrototypeOf(o, p) { QuizQuestion_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return QuizQuestion_setPrototypeOf(o, p); }
...
var QuizQuestion_QuizQuestion =
/*#__PURE__*/
function (_React$PureComponent) {
  QuizQuestion_inherits(QuizQuestion, _React$PureComponent);
  ...
  function QuizQuestion() {
    ...
    QuizQuestion_classCallCheck(this, QuizQuestion);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = QuizQuestion_possibleConstructorReturn(this, (_getPrototypeOf2 = QuizQuestion_getPrototypeOf(QuizQuestion)).call.apply(_getPrototypeOf2, [this].concat(args)));

    QuizQuestion_defineProperty(QuizQuestion_assertThisInitialized(QuizQuestion_assertThisInitialized(_this)), "state", {
      shakeButton: false
    });

    QuizQuestion_defineProperty(QuizQuestion_assertThisInitialized(QuizQuestion_assertThisInitialized(_this)), "nextAnimationTimeout", null);

    QuizQuestion_defineProperty(QuizQuestion_assertThisInitialized(QuizQuestion_assertThisInitialized(_this)), "handleAnswerSelected", function (answer) {
      // We cannot change our answer.
      if (!_this.props.canSelectAnswer) {
        return;
      }

      _this.props.onAnswerSelected(answer);
    });

    QuizQuestion_defineProperty(QuizQuestion_assertThisInitialized(QuizQuestion_assertThisInitialized(_this)), "handleNextClick", function () {
      if (!_this.props.selectedAnswer) {
        _this.handleAnswerNotProvided();

        return;
      }

      _this.props.onGoToNextQuestion();
    });

    QuizQuestion_defineProperty(QuizQuestion_assertThisInitialized(QuizQuestion_assertThisInitialized(_this)), "handleAnswerNotProvided", function () {
      if (_this.state.shakeButton) {
        return;
      }
      ...
      _this.animate('smh', 'ready');
    });

    return _this;
  }

  QuizQuestion_createClass(QuizQuestion, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.animate('ready');
    }
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.props.selectedAnswer && prevProps.selectedAnswer !== this.props.selectedAnswer) {
        var correct = this.isCorrectAnswer(this.props.selectedAnswer);
    ...
    key: "animate",
    value: function animate(mode, nextMode) {
      var _this2 = this;
      ...
      if (nextMode) {
        this.nextAnimationTimeout = setTimeout(function (_) {
          _this2.animate(nextMode);
        }, 2000);
      }
    }
  }, {
    ...
    value: function render() {
      ...
      return react_default.a.createElement(react["Fragment"], null, react_default.a.createElement("div", null, react_default.a.createElement(components_Question, {
        question: question,
...
QuizQuestion_defineProperty(QuizQuestion_QuizQuestion, "propTypes", {
  question: prop_types_default.a.object.isRequired,
  selectedAnswer: prop_types_default.a.number,
  canSelectAnswer: prop_types_default.a.bool,
  makeMrSeedReady: prop_types_default.a.func.isRequired,
  makeMrSeedShakeHead: prop_types_default.a.func.isRequired,
  makeMrSeedGiveThumbsUp: prop_types_default.a.func.isRequired,
  onAnswerSelected: prop_types_default.a.func.isRequired,
  onGoToNextQuestion: prop_types_default.a.func.isRequired
});

QuizQuestion_defineProperty(QuizQuestion_QuizQuestion, "defaultProps", {
  canSelectAnswer: true
});

var ConnectedQuizQuestion = connect_connect(null, function (dispatch) {
  return bindActionCreators({
    makeMrSeedReady: actions_makeMrSeedReady,
    makeMrSeedShakeHead: actions_makeMrSeedShakeHead,
...
/*#__PURE__*/
function (_React$PureComponent) {
  Quiz_inherits(Quiz, _React$PureComponent);
  ...
  function Quiz() {
    ...
    Quiz_defineProperty(Quiz_assertThisInitialized(Quiz_assertThisInitialized(_this)), "state", {
      go: null
    });

    Quiz_defineProperty(Quiz_assertThisInitialized(Quiz_assertThisInitialized(_this)), "handleAnswerSelected", function (answer) {
      _this.props.setQuestionAnswer(_this.props.currentQuestionNumber, answer);
    });

    Quiz_defineProperty(Quiz_assertThisInitialized(Quiz_assertThisInitialized(_this)), "handleGoToNextQuestion", function () {
      if (_this.props.currentQuestionNumber < _this.props.questions.length) {
        _this.props.setCurrentQuestionNumber(_this.props.currentQuestionNumber + 1);
      } else {
        _this.props.submitQuizResults();
  ...
  Quiz_createClass(Quiz, [{
    ...
    value: function getQuestion() {
      ...
      return this.props.questions.find(function (q) {
        return q.number == _this2.props.currentQuestionNumber;
      });
    }
  }, {
    ...
    value: function render() {
      if (!this.props.currentQuestionNumber) {
        ...
        return react_default.a.createElement(es_Redirect, {
          to: "/end"
        });
...
Quiz_defineProperty(Quiz_Quiz, "propTypes", {
  attemptId: prop_types_default.a.number.isRequired,
  answers: prop_types_default.a.object.isRequired,
  questions: prop_types_default.a.array.isRequired,
  currentQuestionNumber: prop_types_default.a.number.isRequired,
  setCurrentQuestionNumber: prop_types_default.a.func.isRequired,
  setQuestionAnswer: prop_types_default.a.func.isRequired,
  submitQuizResults: prop_types_default.a.func.isRequired
});

var ConnectedQuiz = connect_connect(function (state) {
  return {
  ...
  return bindActionCreators({
    ...
    submitQuizResults: actions_submitQuizResults
  }, dispatch);
})(Quiz_Quiz);
...
function AssetsLoader_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function AssetsLoader_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function AssetsLoader_createClass(Constructor, protoProps, staticProps) { if (protoProps) AssetsLoader_defineProperties(Constructor.prototype, protoProps); if (staticProps) AssetsLoader_defineProperties(Constructor, staticProps); return Constructor; }

function AssetsLoader_possibleConstructorReturn(self, call) { if (call && (AssetsLoader_typeof(call) === "object" || typeof call === "function")) { return call; } return AssetsLoader_assertThisInitialized(self); }

function AssetsLoader_getPrototypeOf(o) { AssetsLoader_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return AssetsLoader_getPrototypeOf(o); }

function AssetsLoader_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) AssetsLoader_setPrototypeOf(subClass, superClass); }

function AssetsLoader_setPrototypeOf(o, p) { AssetsLoader_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return AssetsLoader_setPrototypeOf(o, p); }

function AssetsLoader_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function AssetsLoader_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
/*#__PURE__*/
function (_PureComponent) {
  AssetsLoader_inherits(AssetsLoader, _PureComponent);

  // Changing some props after mounting will not have any effect.
  function AssetsLoader(props) {
    var _this;

    AssetsLoader_classCallCheck(this, AssetsLoader);

    _this = AssetsLoader_possibleConstructorReturn(this, AssetsLoader_getPrototypeOf(AssetsLoader).call(this, props));

    AssetsLoader_defineProperty(AssetsLoader_assertThisInitialized(AssetsLoader_assertThisInitialized(_this)), "state", {
      imagesLoaded: 0,
      loaded: false
    });

    AssetsLoader_defineProperty(AssetsLoader_assertThisInitialized(AssetsLoader_assertThisInitialized(_this)), "checkLoadingState", function () {
      if (_this.itemsLoaded() >= _this.itemsToLoad()) {
        _this.setState({
          loaded: true
        });
    ...
    AssetsLoader_defineProperty(AssetsLoader_assertThisInitialized(AssetsLoader_assertThisInitialized(_this)), "imageLoaded", function (index) {
  ...
  AssetsLoader_createClass(AssetsLoader, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      ...
      images.forEach(function (imageSrc, i) {
        ...
        img.addEventListener('load', function () {
          return _this2.imageLoaded(i);
        });
        img.src = imageSrc;
        _this2.imageLoaders[i] = img;
      });
      this.checkLoadingState();
    }
  }, {
    key: "getLoadingPercentage",
    value: function getLoadingPercentage() {
      var toLoad = this.itemsToLoad();
    ...
    value: function render() {
      return this.props.render({
        ratio: this.getLoadingPercentage()
      });
    }
  }]);
...
AssetsLoader_defineProperty(AssetsLoader, "propTypes", {
  images: prop_types_default.a.arrayOf(prop_types_default.a.string),
  onLoad: prop_types_default.a.func,
  render: prop_types_default.a.func
});

AssetsLoader_defineProperty(AssetsLoader, "defaultProps", {
  images: [],
...
var imageAssets = [].concat(getSpritesUrls());
...
function (_React$PureComponent) {
  ...
  function App(props) {
    ...
    App_defineProperty(App_assertThisInitialized(App_assertThisInitialized(_this)), "handleGoFullscreen", function (e) {
      e.preventDefault();

      _this.divRef.current.requestFullscreen();
    });
  ...
  App_createClass(App, [{
    ...
    value: function renderNotReady() {
      ...
      return react_default.a.createElement(components_AssetsLoader, {
        images: imageAssets,
        onLoad: function onLoad() {
        ...
        render: function render(props) {
          var pc = Math.round(props.ratio * 100);
          return react_default.a.createElement("div", {
            style: {
              display: 'flex',
              flex: 1,
    ...
    value: function renderContent() {
      return react_default.a.createElement(react_router_dom_es_Switch, null, react_default.a.createElement(react_router_dom_es_Route, {
        ...
        path: "/quiz",
        component: routes_Quiz
      }), react_default.a.createElement(react_router_dom_es_Route, {
        path: "/end",
        component: routes_End
      }));
    }
  }, {
    key: "render",
    value: function render() {
      return react_default.a.createElement(es_HashRouter, null, react_default.a.createElement(react["Fragment"], null, react_default.a.createElement("div", {
        ref: this.divRef,
        className: "mod_readseed-app-wrapper"
      }, react_default.a.createElement("div", {
        className: "mod_readseed-app"
      }, this.state.ready ? this.renderContent() : this.renderNotReady())), react_default.a.createElement("div", {
        style: {
          textAlign: 'center'
        }
...
// EXTERNAL MODULE: /home/fmc/code/php/sm/moodle/node_modules/redux-logger/dist/redux-logger.js
var redux_logger = __webpack_require__(322);
...
}), store_defineProperty(_handleActions2, setQuestionAnswer, function (state, action) {
  return store_objectSpread({}, state, {
    answers: store_objectSpread({}, state.answers, store_defineProperty({}, action.payload.questionNumber, action.payload.answerIndex))
  });
}), _handleActions2), {});
...
var rootReducer = function rootReducer() {
  ...
  state = store_objectSpread({}, state, {
    quiz: store_objectSpread({}, quizReducer(state.quiz, action)),
    mrseed: store_objectSpread({}, mrSeedReducer(state.mrseed, action))
  });
  return state;
};
...
function getStore(options, recorderConfig) {
  ...
  return createStore(rootReducer, initialState, applyMiddleware(redux_thunk_es)); // return createStore(rootReducer, initialState, applyMiddleware(thunk, createLogger()));
}
...
function init(domId, optsId, recConfigId, CloudPoodll) {
  setModule(CloudPoodll);
  var node = document.getElementById(domId);
  var opts = JSON.parse(document.getElementById(optsId).textContent);
  var recConfig = JSON.parse(document.getElementById(recConfigId).textContent);
  var store = getStore(opts, recConfig);
  react_dom_default.a.render(react_default.a.createElement(components_Provider, {
    store: store
  }, react_default.a.createElement(App_App, null)), node);
}
