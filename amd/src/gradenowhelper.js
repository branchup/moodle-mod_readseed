define(['jquery','core/log','mod_readseed/definitions','mod_readseed/popoverhelper'], function($,log,def,popoverhelper) {
    "use strict"; // jshint ;_;

    log.debug('Read Seed Gradenow helper: initialising');
    ...
    return{
       ...
       * return all the transcript words in between those.
        */
        ...
        playword: function(){
            var m = this;//M.mod_readseed.gradenowhelper;
            m.controls.wordplayer.attr('src',M.cfg.wwwroot + '/mod/readseed/tts.php?txt=' + encodeURIComponent($(this).text())
