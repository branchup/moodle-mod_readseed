...
/**
 * Defines all the backup steps that will be used by {@link backup_readseed_activity_task}
 *
 ...
 *
 */
class backup_readseed_activity_structure_step extends backup_activity_structure_step {

    /**
     * Defines the structure of the readseed element inside the webquest.xml file
     *
    ...
    protected function define_structure() {
        ...
        $oneactivity->annotate_files(constants::M_COMPONENT, constants::AUDIOMODEL_FILEAREA, 'id');
        $oneactivity->annotate_files(constants::M_COMPONENT, constants::AUDIOANSWER_FILEAREA, 'id');
